...
async function solvePrivateLog(frontruntx, details) {
    ...
    // Connect To Contract
    const pathToContract = path.resolve(path.join(__dirname, '../contracts/build/contracts/PrivateLog.json'));
    ...
    const pathToAttackContract = path.resolve(path.join(__dirname, '../contracts/build/contracts/AttackPrivateLog.json'));
